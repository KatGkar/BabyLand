...
public class registerUsernamePassword extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LoginManager.getInstance().logInWithReadPermissions(registerUsernamePassword.this, Arrays.asList("public_profile"));
            }
        });
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onError(FacebookException exception) {
                        Toast.makeText(registerUsernamePassword.this, "Facebook is not responding. Please try again later!!", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        //google sing in
        mGoogleSignInClient= GoogleSignIn.getClient(registerUsernamePassword.this
                ,googleSignInOptions);
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(registerUsernamePassword.this, "User created successfully!", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(registerUsernamePassword.this, doctorParentChoose.class);
                        startActivity(intent);
                    } else {
                        // If sign in fails, display a message to the user.
                        Toast.makeText(registerUsernamePassword.this, task.getException().getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                if (task.getResult().getSignInMethods().size() == 0){
                    ...
                    firebaseAuth.signInWithCredential(authCredential)
                            .addOnCompleteListener(registerUsernamePassword.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(registerUsernamePassword.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    // email existed
                    Toast.makeText(registerUsernamePassword.this, "The email address is already in use by another account!", Toast.LENGTH_SHORT).show();
                }
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(registerUsernamePassword.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
